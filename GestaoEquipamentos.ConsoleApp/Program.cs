...
namespace GestaoEquipamentos.ConsoleApp
{
    class Program
    {
        ...
        */
        ...
        #region NOVAS ESPECIFICAÇÕES FEITAS [OK]
        ...
        Requisito 1.2: Como funcionário, Junior quer ter a possibilidade de visualizar todos os solicitantes registrados
            ...
            Requisito 1.3: Como funcionário, Junior quer ter a possibilidade de editar um solicitante, sendo que ele possa editar todos os campos.
        ...
        Requisito 1.4: Como funcionário, Junior quer ter a possibilidade de excluir um solicitante que esteja registrado.
     
                 •  A lista de solicitantes deve ser atualizada
        */
        #endregion

        #region NOVAS ESPECIFICAÇÕES NAO FEITAS (MOTIVO - ERRO NA CLASS CHAMADOS, AONDE FALA QUE MEU SOLICIRAÇÃO ESTA RETORNANDO NULL)
        /*Requisito 2.1: Como funcionário Junior quer ter a possibilidade de registrar o solicitante nos chamados de manutenções que são efetuadas nos equipamentos registrados

        Requisito 2.2: Como funcionário Junior quer ter a possibilidade de visualizar também o solicitante nos chamados registrados para controle.

        Requisito 2.3: Como funcionário Junior quer ter a possibilidade de editar o solicitante do chamado que esteja registrado
        */
        #endregion
        ...
        static void Main(string[] args)
        {
            ...
            TelaPrincipal telaPrincipal = new TelaPrincipal(
                controladorEquipamento, controladorSolicitante, telaEquipamento, telaSolicitante, controladorChamado);
